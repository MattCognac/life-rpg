  ...
  <DialogPortal>
    ...
    <div className="pointer-events-none fixed inset-0 z-[51] flex items-center justify-center p-4">
      <DialogPrimitive.Content
        ref={ref}
        className={cn(
          "pointer-events-auto relative flex min-h-0 w-full max-w-lg max-h-[calc(100dvh-2rem)] flex-col gap-4 overflow-hidden border border-primary/40 bg-card p-6 shadow-2xl outline-none data-[state=open]:animate-fade-in-up",
          className
        )}
        style={{
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Title
    ref={ref}
    className={cn(
      "font-display text-xl tracking-widest uppercase text-gradient-gold",
      className
    )}
    {...props}
  />
